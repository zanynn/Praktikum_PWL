        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="upload-zan" name="image" value="{{$bodykit->imageurl}}"></br>
                    <img width="300px" src="{{asset('storage/'.$bodykit->imageurl)}}"> 
                </div>
                </div><!-- /.col-md-6 -->
                <div class="col-md-6"><br><br>
                <div class="form-group">
                    <label for="content" class="zantext">Content</label>
                    <textarea class="form-control textareacontent" name="content">{{$bodykit->content}}</textarea></br>
                </div>
                </div><!-- /.col-md-6 -->
