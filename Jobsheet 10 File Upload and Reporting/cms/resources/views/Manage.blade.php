...
<section class="service-icon-style ptb-50">
    ...
    <span class="bordered-icon"><i class="fa fa-circle-thin"></i></span>
        ...
        <table class="table table-lol">
            ...
            <tr>
            <td>{{$i++}}</td>
            <td><img width="150px" src="{{asset('storage/'.$a->imageurl)}}"> </td>
            <td>{{$a->title}}</td>
            <td>{{$a->created_at}}</td>
            <td>
        ...
        <a href="/cetak_pdf" class="btn btn-primary" target="_blank"><i class="fa fa-print" aria-hidden="true"></i>  Print PDF</a>
        </div>
        </div>
        <!-- /.row -->
